...
SharkViewer.prototype.init = function () {
	...
	this.renderer = new THREE.WebGLRenderer({
		...
		preserveDrawingBuffer   : this.screenshot,   // required to support .toDataURL()
	});
	...
	if (this.screenshot) {
		//document.getElementById(this.dom_element).addEventListener('keydown', this.ss.bind(this));
		window.addEventListener('keydown', this.ss.bind(this));
	}
};
...
SharkViewer.prototype.ss = function() {
